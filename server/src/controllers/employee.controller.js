      ...
      for (let i = 1; i < rows.length; i++) {
        ...
        try {
          await Employee.create({
            ...
            beneficiary_building_no:   data.beneficiary_building_no   || null,
            beneficiary_building_name: data.beneficiary_building_name || null,
            beneficiary_street:        data.beneficiary_street        || null,
            beneficiary_city:          data.beneficiary_city          || null,
            beneficiary_postal_code:   data.beneficiary_postal_code   || null,
