    ...
    for (let attempt = 1; attempt <= MAX_ATTEMPTS; attempt++) {
      ...
      try {
        const id = await db.insert('payslips', {
          ...
          sss_mpf:          parseFloat(data.sss_mpf      || 0),
          philhealth_ee:    parseFloat(data.philhealth_ee || 0),
          pagibig_ee:       parseFloat(data.pagibig_ee   || 0),
          bir_tax:          parseFloat(data.bir_tax      || 0),
          tax_deductions:   parseFloat(data.bir_tax      || data.tax_deductions   || 0),
          other_deductions: parseFloat(data.sss_ee || 0) + parseFloat(data.sss_mpf || 0) + parseFloat(data.philhealth_ee || 0) + parseFloat(data.pagibig_ee || 0),
